...
class _HomePageState extends State<HomePage> {
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Icon(
                                            Icons.star,
                                            // color: int.parse(singleDoctorModel.rating)>=0 ? Colors.yellow : Colors.black38,
  ...
  Future _getAllSetMenuItems() async{
    try{
      ...
      if(response.statusCode == 200 || response.statusCode==201){
        ...
        for(int i=0;i<dynamicSetMenuList.length;i++){
          ...
          setState(() {
            allSetMenuList.add(setMenu);
          });
        }
      }
      return allSetMenuList;
    }
    catch(error){
      print(error);
    }
  ...
  Future _getAllBannerItems() async{
    try{
    ...
    try{
      ...
      if(response.statusCode==200 || response.statusCode==201){
        ...
        for(int i=0;i<dynamicProductList.length; i++){
          ...
          setState(() {
            allPopularItemList.add(popularItems);
          });
        }
      }
    }
